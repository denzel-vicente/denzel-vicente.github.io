...
const translations = {
    en: {
        ...
        about_journey: "I began my programming journey over <strong>4 years ago</strong>. Evolving from calculators and custom 2D physics engines in JavaScript, I now specialize in architecting and deploying full-scale production applications, including school portals and complex reservation systems.",
        about_specialty_desc: "With <strong>2 years of professional experience</strong>, I specialize in web systems development and hardware optimization, primarily working with the JavaScript, Node.js, and PHP ecosystems.",
        ...
        about_stat_professional_val: "2 Years",
    ...
    pt: {
        ...
        about_journey: "Comecei minha jornada de programação há <strong>mais de 4 anos</strong>. Evoluindo de calculadoras e motores de física 2D em JavaScript, hoje me especializo em arquitetar e implantar aplicações completas em escala de produção, incluindo portais escolares e sistemas complexos de reserva.",
        about_specialty_desc: "Com <strong>2 anos de experiência profissional</strong>, especializei-me no desenvolvimento de sistemas web completos e otimização de hardware, trabalhando principalmente com os ecossistemas JavaScript, Node.js e PHP.",
        ...
        about_stat_professional_val: "2 Anos",
